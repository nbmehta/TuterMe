...
<head>
  ...
  <!-- bootstrap change comment -->
  <link rel="stylesheet" href="<c:url value="/resources/css/bootstrap/bootstrap.min.css"/>" />

  <!-- animate.css -->
  <link rel="stylesheet" href="<c:url value="/resources/css/animate/animate.css"/>" />
  <link rel="stylesheet" href="<c:url value="/resources/css/animate/set.css"/>" />

  <!-- gallery -->
  <link rel="stylesheet" href="<c:url value="/resources/css/gallery/blueimp-gallery.min.css"/>">
...
<div id="works"  class=" clearfix grid">
  <figure class="effect-oscar  wowload fadeIn">
    <img src="<c:url value="/resources/images/portfolio/1.jpg"/>" alt="img01"/>
    <figcaption>
      <h2>Nature</h2>
      <p>Lily likes to play with crayons and pencils<br>
        <a href="<c:url value="/resources/images/portfolio/1.jpg"/>" title="1" data-gallery>View more</a></p>
    </figcaption>
  </figure>
  <figure class="effect-oscar  wowload fadeInUp">
    <img src="<c:url value="/resources/images/portfolio/2.jpg"/>" alt="img01"/>
    <figcaption>
      <h2>Events</h2>
      <p>Lily likes to play with crayons and pencils<br>
        <a href="<c:url value="/resources/images/portfolio/2.jpg"/>" title="1" data-gallery>View more</a></p>
    </figcaption>
  </figure>
  <figure class="effect-oscar  wowload fadeInUp">
    <img src="<c:url value="/resources/images/portfolio/3.jpg"/>" alt="img01"/>
    <figcaption>
      <h2>music</h2>
      <p>Lily likes to play with crayons and pencils<br>
        <a href="<c:url value="/resources/images/portfolio/3.jpg"/>" title="1" data-gallery>View more</a></p>
    </figcaption>
  </figure>
  <figure class="effect-oscar  wowload fadeInUp">
    <img src="<c:url value="/resources/images/portfolio/4.jpg"/>" alt="img01"/>
    <figcaption>
      <h2>Vintage</h2>
      <p>Lily likes to play with crayons and pencils<br>
        <a href="<c:url value="/resources/images/portfolio/4.jpg"/>" title="1" data-gallery>View more</a></p>
    </figcaption>
  </figure>
  <figure class="effect-oscar  wowload fadeInUp">
    <img src="<c:url value="/resources/images/portfolio/5.jpg"/>" alt="img01"/>
    <figcaption>
      <h2>Typers</h2>
      <p>Lily likes to play with crayons and pencils<br>
        <a href="<c:url value="/resources/images/portfolio/5.jpg"/>" title="1" data-gallery>View more</a></p>
    </figcaption>
  </figure>

  <figure class="effect-oscar  wowload fadeInUp">
    <img src="<c:url value="/resources/images/portfolio/6.jpg"/>" alt="img01"/>
    <figcaption>
      <h2>hotel</h2>
      <p>Lily likes to play with crayons and pencils<br>
        <a href="<c:url value="/resources/images/portfolio/6.jpg"/>" title="1" data-gallery>View more</a></p>
    </figcaption>
  </figure>
  <figure class="effect-oscar  wowload fadeInUp">
    <img src="<c:url value="/resources/images/portfolio/7.jpg"/>" alt="img01"/>
    <figcaption>
      <h2>Chinese</h2>
      <p>Lily likes to play with crayons and pencils<br>
        <a href="<c:url value="/resources/images/portfolio/7.jpg"/>" title="1" data-gallery>View more</a></p>
    </figcaption>
  </figure>
  <figure class="effect-oscar  wowload fadeInUp">
    <img src="<c:url value="/resources/images/portfolio/8.jpg"/>" alt="img01"/>
    <figcaption>
      <h2>Dicrap</h2>
      <p>Lily likes to play with crayons and pencils<br>
        <a href="<c:url value="/resources/images/portfolio/8.jpg"/>" title="1" data-gallery>View more</a></p>
    </figcaption>
  </figure>
  <figure class="effect-oscar  wowload fadeInUp">
    <img src="<c:url value="/resources/images/portfolio/9.jpg"/>" alt="img01"/>
    <figcaption>
      <h2>Coffee</h2>
      <p>Lily likes to play with crayons and pencils<br>
        <a href="<c:url value="/resources/images/portfolio/9.jpg"/>" title="1" data-gallery>View more</a></p>
    </figcaption>
  </figure>
